...
public interface MovieApiService {
    ...
    @POST(Constants.PATH_OAUTH + Constants.PATH_TOKEN)
    Call<RefreshTokenResponseModel> refreshToken(@Body RequestBody refreshRequestBody
            /*@Query(Constants.PARAM_KEY_GRANT_TYPE) String grantType,
    ...
    @GET(Constants.PATH_API + Constants.PATH_WEB_SERVICE_VERSION + Constants.PATH_MOVIES)
    Call<MoviePageListModel> searchInMoviesByKeyword (@Query(Constants.PARAM_KEY_QUESTION) String keyword,
